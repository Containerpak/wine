...
RUN arch="$(dpkg --print-architecture)" && \
    ...
    if [ "$arch" = amd64 ]; then \
        ...
        libwayland-egl1:i386 libxml2-16:i386 libxslt1.1:i386 \
        libxshmfence1:i386; \
    fi && \
    cpak-clean-junk

ENV LD_LIBRARY_PATH="/usr/lib:/usr/lib/aarch64-linux-gnu:/usr/lib/i386-linux-gnu:/usr/lib/x86_64-linux-gnu" \
    GST_PLUGIN_SYSTEM_PATH="/usr/lib/extensions/gstreamer-1.0:/usr/lib/aarch64-linux-gnu/gstreamer-1.0:/usr/lib/x86_64-linux-gnu/gstreamer-1.0:/usr/lib/i386-linux-gnu/gstreamer-1.0"
